    ...
    <v-container>
      <div class="d-flex justify-center">
        <div class="text-center mx-3">
          <h2 class="text-h3 text-lg-h2">CONTACT</h2>
          <v-divider style="padding-top: 5px" class="my-auto octonary" />
          <div class="text-body-2 font-weight-bold octonary--text mt-1">お問い合わせ</div>
        </div>
      </div>
